    ...
    promise = new Promise(async (resolve, reject) => {
      try {
        ...
        if (typeof PhysXFactory !== 'function') {
          throw new Error('PhysX factory function not found after importing bindings. Check physx-js-webidl.js build settings (EXPORT_NAME, MODULARIZE).');
        }
        ...
        try {
           ...
           physxInstance = await PhysXFactory({ locateFile: (file) => {
